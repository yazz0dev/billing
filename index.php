...
<div class="container homepage-hero-container">
    ...
    <div class="homepage-cards-container">
        <div class="homepage-login-card glass">
            <img src="https://cdn.jsdelivr.net/npm/heroicons@2.1.1/outline/user-circle.svg" alt="Admin Icon">
            <h3>Administrator</h3>
        ...
        <div class="homepage-login-card glass">
            <img src="https://cdn.jsdelivr.net/npm/heroicons@2.1.1/outline/shopping-cart.svg" alt="Staff Icon">
            <h3>Staff Member</h3>
